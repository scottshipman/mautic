            ...
            <li class="list-group-item bg-auto bg-light-xs">
                ...
                <div class="box-layout">
                    <div class="col-md-1 va-m">
                        <span class="mt-xs label label-<?php echo $yesClass; ?>" data-toggle="tooltip" title="<?php echo $view['translator']->trans('mautic.report.campaign.yes.percent'); ?>">
                            <?php echo $event['yesPercent'].'%'; ?></span>
                        <?php if ('action' !== $event['eventType']): ?>
                            <span class="label label-danger" data-toggle="tooltip"
                                  title="<?php echo $view['translator']->trans(
                                      'mautic.report.campaign.no.percent'
                                  ); ?>"><?php echo $event['noPercent'].'%'; ?></span>
